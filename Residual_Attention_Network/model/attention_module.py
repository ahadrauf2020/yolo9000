...
class AttentionModule_stage1_cifar(nn.Module):
    ...
    def forward(self, x):
        ...
        out_mpool1 = self.mpool1(x)
        # if self.TEST1 == 1:
        #     out_mpool1 = self.mpool1(out_mpool1)
        # self.TEST1 += 1 
        ...
        # print(self.interpolation1(out_middle_2r_blocks).size())
        # print(out_down_residual_blocks1.size())
        ...
        # print(self.interpolation2(out_up_residual_blocks1).size())
        # print(out_trunk.size())
        # if self.TEST2 == 1:
        #     out_trunk = self.mpool1(out_trunk)
        # self.TEST2 += 1 
